...
public class QQSecureViewIndex extends View {
    /** 绘制渐变呼吸环的画笔 */
    ...
    public QQSecureViewIndex(Context context) {
        super(context);
        init();
    }

    public QQSecureViewIndex(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public QQSecureViewIndex(Context context, AttributeSet attrs, int defStyleAttr) {
